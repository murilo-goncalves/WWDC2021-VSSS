/*: [Introduction](@previous)
 ...
 - - -
 - Note:
  If the simulation doesn't start automaticaly and keep stuck at "Running...", you can stop and run again the playground page. This issue is discussed [here](https://developer.apple.com/forums/thread/101346?page=1).
 - - -
