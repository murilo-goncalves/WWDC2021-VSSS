...
/*:
 ...
 The attacker strategy is just as simple! It follows the ball and kicks if it's *x* coordinate is "behind the ball, depending on the attacker's team color. Besides, if the ball is inside the attacker's team penalty area, the attacker won't follow the ball and will slowly move away, to avoid own goals and give the goalkeeper space to kick.
